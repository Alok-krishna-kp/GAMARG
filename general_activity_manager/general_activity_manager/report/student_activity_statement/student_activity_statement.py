...
def get_data(filters):
    ...
    query = "SELECT participant_type, participant, department, event_name, category, event_date, certificate FROM `tabActivity Management` " + conditions + " ORDER BY participant, event_date DESC"
