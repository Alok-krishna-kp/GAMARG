...
def get_student_activities(university_reg_no=None, student_id=None, start_date=None):
    ...
    activities = frappe.get_all(
        "Activity Management",
        filters=filters,
        fields=["name", "event_name", "event_date", "category", "department", "participant_type", "workflow_state", "certificate"],
...
def get_department_activities(department):
    ...
    activities = frappe.get_all(
        ...
        fields=["name", "event_name", "event_date", "category", "department", "participant", "participant_type", "workflow_state", "certificate"],
        order_by="event_date asc",
        ignore_permissions=True,
    )
    for a in activities:
